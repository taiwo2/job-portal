...
const EditJob = () => {
  ...
  const editedJobs = jobs.find((job) => job._id == id);
  ...
  const onFinalSubmit = (values) => {
    ...
    Obj._id = id 
    dispatch(editJobs(Obj));
  };
  return (
    <DefaultLayout>
      <Tabs defaultActiveKey="0" activeKey={activeTab}>
        <TabPane key="0" tab="Job Info">
          <Form layout="vertical" onFinish={onSubmit} initialValues={editedJobs}>
            <Row gutter={16}>
              <Col lg={8} sm={24}>
                <Form.Item
                  label="Title"
        ...
        <TabPane key="1" tab="Company Info">
          <Form layout="vertical" onFinish={onFinalSubmit} initialValues={editedJobs}>
            <Row gutter={16}>
              <Col lg={8} sm={24}>
                <Form.Item
                  label="Company Name"
